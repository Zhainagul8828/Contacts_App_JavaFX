...
public class ContactsAppController {
    ...
    public void initialize(){
        contacts.add(new Contact("Zhainagul","Zhumanzar kyzy","zhzhzhzh@gmail.com","+996123123123"));
        contacts.add(new Contact("Emily","Clarke","emily@ucentralasia.com","+1239959995995"));
        contacts.add(new Contact("Rebekah","Ray","rebah.ray@yandex.com","+312234586905904"));
